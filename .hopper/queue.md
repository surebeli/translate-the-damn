...
| T-MAC-30 | code-impl | pending | T-MAC-29 | normal | Clipboard poller: `NSPasteboard.general.changeCount` ~250ms; self-write guard (hash); skip non-text/empty/>maxChars; dedupe; debounce; supersede. | kimi |
